            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                    	<a HREF="javascript:document.catalogSubmitForm.submit()">Catálogo</a>
                        <form action="ControllerServlet" name="catalogSubmitForm" novalidate method="post">
                    ...
                    <li class="page-scroll">
                        <a HREF="javascript:document.chatSubmitForm.submit()">Chat</a>
                        <form action="ControllerServlet" name="chatSubmitForm" novalidate method="post">
