		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="page-scroll"><a
					HREF="javascript:document.catalogSubmitForm.submit()">Catálogo</a>
					<form action="ControllerServlet" name="catalogSubmitForm"
						novalidate method="post">
						<input type="hidden" name="pAccion" value="catalog">
					</form></li>
				<li class="page-scroll"><a
					HREF="javascript:document.misProductosSubmitForm.submit()">Mis
						productos</a>
				...
				<li class="page-scroll"><a
					...
					<form action="ControllerServlet" name="userProfileSubmitForm"
						novalidate method="post">
						<input type="hidden" name="pAccion" value="ObtenerUsuarioMostrarPerfil">
					</form></li>
				<li class="page-scroll"><a
					HREF="javascript:document.createProductSubmitForm.submit()">Crear
						Producto</a>
					<form action="ControllerServlet" name="createProductSubmitForm"
						novalidate method="post">
